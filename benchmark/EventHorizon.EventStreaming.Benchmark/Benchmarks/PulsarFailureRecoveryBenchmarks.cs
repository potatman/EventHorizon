...
using EventHorizon.EventStreaming.Benchmark.Extensions;
...
public class PulsarFailureRecoveryBenchmarks
{
    ...
    public void Cleanup()
    {
        ...
        topicAdmin.DeleteTopicAsync(
            $"persistent://test_pricing/Event/subscription__EventHorizon.EventStreaming.Benchmark-FailBenchmark_{UniqueTestId}__streamFailureState",
